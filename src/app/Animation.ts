...
export const ChartBottomTop =
trigger('ChartBottomTop', [
  transition('* => *', [
    ...
    query(':enter', stagger('100ms', [
      animate('1s ease-in', keyframes([
        ...
        style({ opacity: 0, transform: 'translateY(95%) ', offset: 0.3 }),
        style({ opacity: 0, transform: 'translateY(55%) ', offset: 0.5 }),
        style({ opacity: 0, transform: 'translateY(25%) ', offset: 0.7 }),
        style({ opacity: 1, transform: 'translateY(0%)', offset: 1.0 }),
      ]))]), { optional: true }),
